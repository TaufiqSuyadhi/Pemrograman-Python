...
'''
sapaan = "Haloo, Sahabat Robonesia"
...
'''
sapaan = "Haloo, Sahabat Robonesia di mana pun Anda berada!"
t = len(sapaan)
print(sapaan)
...
'''
kata1 = "Hallo"; kata2 = "Sahabat"; kata3 = "Robonesia!"
C = ['Hallo','Sahabat','Robonesia!']        # List C
print ("List C:", C)
...
'''
kalimat1 = "Haloo, nama saya Taufiq"
kalimat2 = kalimat1.replace('Taufiq','Suyadhi')
print (kalimat1)
print (kalimat2)
'''
